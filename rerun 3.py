...
url_2 = "https://employment.en-japan.com/search/issue_list_2293/"
print(url_2)
...
for firms in table_list:
    ...
    for results in firms.find_all("tr"):
        ...
        if len(job_information) > 1:
            for job_detail in job_information:
                print(job_detail)
...
"""    
        ...
        job_link = results.find_all('a', href=True).attrs['href']
