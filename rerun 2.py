...
url_1 = "https://employment.en-japan.com/search/issue_index_2010"
for case_number in range(1474, 1522):

    url_2 = "https://employment.en-japan.com/search/issue_list_" + str(case_number) + "/"  # link of every year
    print(url_2)
    ...
    for firms in table_list:
        ...
        for results in firms.find_all("tr"):
            ...
            try:
                ...
                Item.to_csv(r"C:\\Users\Ray94\Desktop\2010tuikadata.csv", mode='a', index=False, header=None,
                            encoding="utf-8_sig")

                log = pd.DataFrame([[url_1, url_2, url_3]])

                log.to_csv(r"C:\\Users\Ray94\Desktop\2010tuikalog.csv", mode='a', index=False, header=None,
                           encoding="utf-8_sig")
                time.sleep(8)
            except Exception as e:
                Error = pd.DataFrame([[url_2, url_3, str(e)]])
                Error.to_csv(r"C:\\Users\Ray94\Desktop\2010tuikaerror.csv", mode='a', index=False, header=None,
                             encoding="utf-8_sig")
                pass
